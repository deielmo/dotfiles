...
# source my own custom commands that i store in https://github.com/deielmo/mattdot.git
source /usr/local/custom/mattdot/aliases

# Which plugins would you like to load? (plugins can be found in ~/.oh-my-zsh/plugins/*)
# Custom plugins may be added to ~/.oh-my-zsh/custom/plugins/
# Example format: plugins=(rails git textmate ruby lighthouse)
# Add wisely, as too many plugins slow down shell startup.
plugins=(autoenv bundler colorize common-aliases gem postgres ruby themes vim-interaction vundle z git history-substring-search zsh-syntax-highlighting)
...
# Git settings
git config --global user.name "deielmo"
git config --global user.email "dei.elmo@gmail.com"
git config --global color.ui auto
git config --global credential.helper osxkeychain

# ZSH-OSX-COMPLETIONS
fpath=(/usr/local/osx-zsh-completions/ $fpath)
